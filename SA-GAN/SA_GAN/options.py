...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--dataset', default='MSL', help='dataset')
        self.parser.add_argument('--filename', default='T-5', help='dataset name')
        ...
        self.parser.add_argument('--update_method', type=int, default=2, help='update method')
        self.parser.add_argument('--sample_method', type=str, default='seq', help='sampling method')
        self.parser.add_argument('--delta', type=float, default=0.01, help='delta')
        self.parser.add_argument('--ratio', type=float, default=0.05, help='ratio')
